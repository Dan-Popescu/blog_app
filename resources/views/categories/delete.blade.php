                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex justify-center items-center my-8">
                            <h2 class="text-2xl font-semibold"> {{ __('Delete categories') }}</h2>
                        </div>
                        <form method="post" action="{{ route('categories.delete') }}" class="flex flex-col items-center justify-center">
                            @csrf
                            @method('delete')
